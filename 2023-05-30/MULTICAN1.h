...
/*-----------------------------------------------------Includes------------------------------------------------------*/
/*********************************************************************************************************************/
#include "Ifx_Types.h"           /* Includes type definitions for Infineon XMC microcontroller */
#include "IfxMultican_Can.h"     /* Includes CAN driver API definitions */
#include "IfxMultican.h"         /* Includes CAN driver API definitions */
#include "IfxPort.h"             /* For GPIO Port Pin Control */
#include "Bsp.h"                 /* Includes Board Support Package (BSP) definitions */
...
#define STB                         &MODULE_P20,6               /* STB pin configuration */

#define WAIT_TIME_1ms               1                           /* Wait time in milliseconds */
#define WAIT_TIME_5ms               5                           /* Wait time in milliseconds */
#define WAIT_TIME_10ms              10                          /* Wait time in milliseconds */
#define WAIT_TIME_20ms              20                          /* Wait time in milliseconds */
#define WAIT_TIME_40ms              40                          /* Wait time in milliseconds */
#define WAIT_TIME_50ms              50                          /* Wait time in milliseconds */
#define WAIT_TIME_100ms             100                         /* Wait time in milliseconds */
...
/*-----------------------------------------------Function Prototypes-------------------------------------------------*/
/*********************************************************************************************************************/
void canIsrTxHandler(void);         /* CAN transmit interrupt service routine */
void canIsrRxHandler(void);         /* CAN receive interrupt service routine */
void initMultican(void);            /* Initialize the CAN module */
void transmitCanMessage(void);      /* Transmit a CAN message */
void initLed(void);                 /* Initialize the LEDs */
void blinkLED1(void);               /* Blink LED1 */
void blinkLED2(void);               /* Blink LED2 */
