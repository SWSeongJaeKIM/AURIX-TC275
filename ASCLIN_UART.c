...
#define SIZE                    7                                     /* Size of the string                       */
...
CRC16_MODBUS(const uint8 *nData, uint16 wLength);
...
void set_pwm_channel(int cma)
{
    ...
    protocal_test[4] = cma;            // data number
